...
public class WebViewSample extends Application {
    ...
    public void start(Stage stage) {
        ...
        scene = new Scene(new Browser(), 950, 500, Color.web("#666970"));
    ...
    public Browser() {
        ...
        hplUrlInicio.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent e) {
                    ...
                    webEngine.load(WebViewSample.class.getResource("fuentes/paginaPrincipal.html").toExternalForm());
                }
            });                     
        ...
        hplUrlInfo.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent e) {
                    ...
                    webEngine.load(WebViewSample.class.getResource("fuentes/sobreapp.html").toExternalForm());
                }
            });           
